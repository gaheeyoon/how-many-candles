...
태어난 해만 입력하면 올해 생일에 필요한 촛불 개수를 즉시 계산해주는 심플하고 위트 있는 웹 앱입니다.

![App Screenshot](./screenshot.png)

## ✨ 주요 기능
- **자동 연도 계산**: 매년 코드를 수정할 필요 없이, 현재 연도를 기준으로 나이를 계산합니다.
...
## 💰 수익화 (Ads)
이 서비스는 Google AdSense 광고를 포함할 수 있도록 최적화되어 있으며, `privacy.html`과 `ads.txt`가 세팅되어 있습니다.
